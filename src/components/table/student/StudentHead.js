    ...
    <div>
      <div className={style.flexContainer}>
        <p className={style.textHead}>
          student: <span className={style.nameStudent}>{name}</span>
        </p>
        <p className={style.textHead}>
          id:<span className={style.nameStudent}>{id}</span>
        </p>
      </div>
      <div className={style.flexContainer}>
        <div className={style.button}>
          <p className={style.textHead}>all concepts</p>
          <svg className={style.down}>
            <use href={sprite + "#icon-down"}></use>
          </svg>
        </div>
        <div className={style.button}>
          <p className={style.textHead}>All score</p>
          <svg className={style.down}>
            <use href={sprite + "#icon-down"}></use>
          </svg>
        </div>
        <div className={style.button}>
          <p className={style.textHead}>All speed</p>
          <svg className={style.down}>
            <use href={sprite + "#icon-down"}></use>
          </svg>
        </div>
        <div className={style.calendar}>
          <label>
            <input className={style.input} placeholder="Select Period"></input>
          </label>
